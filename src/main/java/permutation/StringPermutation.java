...
public class StringPermutation {
        ...
        /**
         * Returns true if s is a permutation of t.
         * @param s
         * @param t
         * @return boolean
         */
        public static boolean methodTwo(String s, String t) {
        ...
        */
        public static boolean methodOne(String s1, String s2) {
                // brute force
